...
* 雲義科技
	...
	* 工作成果
		...
		* 降低系統維運成本
			* 提升系統品質：系統叫修事件降低40%
			* 調整UI設計：使系統提示訊息更易了解，降低使用者諮詢事件25%
			* 強化系統流程控制：系統因流程控制不當發生資料錯誤，導致需人工介入調整資料事件降低75%

		* 系統執行效能及正確性提升
			* 調整SQL語句結構，使報表印製速度提升由5分鐘降低至3秒
			* 調整系統架構，利用流程控制降低使用者操作異常與資料產出結果錯誤率
		* 專案經理任內順利按時完成 7 項新專案與 2 項系統架構調整案
...
* 百年翻譯社
	...
	* 工作成果
		...
		* 了解公司目前資安狀況，參與業界相關資安研討會，提案規劃資安架構		
